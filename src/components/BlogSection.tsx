...
const LOADED_BLOG_POSTS: BlogPost[] = Object.keys(markdownFiles).map((filePath, idx) => {
...
export default function BlogSection({ onSelectPost, onNavigateToContact }: BlogSectionProps) {
  ...
  const activePost = LOADED_BLOG_POSTS.find(p => p.slug === activeSlug);
  ...
  return (
    <section id="blog" className="py-20 bg-[#0b0f19] text-slate-100 relative overflow-hidden">
      {/* Background ambient lighting */}
      <div className="absolute inset-0 z-0 opacity-15 pointer-events-none">
        <div className="absolute top-1/3 left-1/4 w-[40vw] h-[40vw] bg-bumn-blue/10 blur-[160px]" />
        <div className="absolute bottom-10 right-10 w-[30vw] h-[30vw] bg-amber-500/10 blur-[140px]" />
      </div>

      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">

        {/* -------------------------------------------------------------
            VIEW 1: DETAIL ARTIKEL (Single Post View)
        ------------------------------------------------------------- */}
        {activePost ? (
          <div className="max-w-4xl mx-auto animate-in fade-in slide-in-from-bottom-4 duration-300">
            ...
            {/* Article Main Content (Rendered with react-markdown) */}
          ...
          /* -------------------------------------------------------------
              VIEW 2: INDEX DAFTAR ARTIKEL (Grid & Featured View)
          ------------------------------------------------------------- */
          <div>
            {/* Header Title */}
            <div className="text-center max-w-3xl mx-auto space-y-4 mb-12">
              <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-bumn-blue/10 border border-bumn-blue/30 text-xs font-semibold text-blue-400 uppercase tracking-widest">
                ...
                <span>Insight & Thought Leadership GRC</span>
              </div>
              <h2 className="text-3xl sm:text-4xl font-bold font-display text-white tracking-tight">
                Pusat Edukasi & Regulasi <span className="text-gradient-gold">BUMN & Finansial</span>
              </h2>
